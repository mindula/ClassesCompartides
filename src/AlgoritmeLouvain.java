...
public class AlgoritmeLouvain extends Algoritme<NodeLovain> {
    ...
    ArrayList<Comunitat<NodeLovain>> cercarComunitats(Graf<NodeLovain> graf) {
        ...
        Comunitat<NodeLovain> c1 = new Comunitat<NodeLovain>(1);
        c1.afegirNode(new NodeLovain());
        c1.afegirNode(new NodeLovain());
        c1.afegirNode(new NodeLovain());
        c1.afegirNode(new NodeLovain());
        c1.afegirNode(new NodeLovain());

        Comunitat<NodeLovain> c2 = new Comunitat<NodeLovain>(2);
        c2.afegirNode(new NodeLovain());
        c2.afegirNode(new NodeLovain());
        c2.afegirNode(new NodeLovain());
        c2.afegirNode(new NodeLovain());
        c2.afegirNode(new NodeLovain());
